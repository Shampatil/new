...
gymManagementApp.controller('servicesController', function ($scope, $state, $http, $rootScope, $location, Idle, $route, exDialog, commonService, $localStorage, userSessionService) {
...
{ id: 5, position: 'Spa Trainer', description: 'As a Fitness Instructor you will become part of dedicated Wellbeing team that provides a unique fitness experience for our guests throughout their patronage', availability: false, noofpost: 9 }
        ...
        $http({ method: "GET", url: "http://gym.excellencea.com/api/service" })
        ...
        $location.path('/dashboard/services');
