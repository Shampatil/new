...
gymManagementApp.controller('dashboardController', function ($scope, $state, $http, $rootScope, $location, Idle, $route, exDialog,commonService, $localStorage, userSessionService) {

    //$rootScope.displayTitle = false;
    //$rootScope.notificationCount = 0;
    //$scope.Menus = {};
    //$scope.IsUserMenuVisible = true;
    //$scope.states = {};
    //$scope.states.activeItem = 1;

    //$scope.IsReadonlyOpSchedule = false;
    //$scope.IsReadonlyNotifications = false;
    //$scope.IsReadonlyPatientSearch = false;
    ...
    //$scope.currentUserRoleType = loggedInUserDetailsCookie.RoleType;
    ...
    //                $scope.Specility = data.Specility
    ...
    //    }
    //    else {
    //        $scope.DoctorName = commonService.userDetail.DoctorName
    //        $scope.Specility = commonService.userDetail.Specility
    //        $scope.Designation = commonService.userDetail.Designation
    //    }
    //}

    //$rootScope.$on("PatientInfo", function () {
    //    var id = localStorage.getItem('patientId');
    //    var visitingDetailId = JSON.parse(localStorage.getItem('visitingDetailId'));
    //    if (id == null)
    //        return false;

    //    if (visitingDetailId == null) {
    //        visitingDetailId = '00000000-0000-0000-0000-000000000000';
    //    }

    //    var config = {
    //        method: 'POST',
    //        url: 'PracticeManagement.Services/api/PatientInfo/PatientBasicInfo',
    //        params: { "patientId": id, "visitingDetailId": visitingDetailId }
    //    };
    ...
    //            $scope.IsKnown = data.IsKnownAllergy;
    //            if (data.PatientHealthParams != null) {
    //                angular.forEach(data.PatientHealthParams, function (item) {
    //                    if (item.Name == 'BMI (Body Mass Index)')
    //                        $scope.PatientSummary.PatientInfo.BMI = item.Value;
    //                    else if (item.Name == 'Height (Centimeters)')
    //                        $scope.PatientSummary.PatientInfo.Height = item.Value;
    //                    else if (item.Name == 'Weight (Kilograms)')
    //                        $scope.PatientSummary.PatientInfo.weight = item.Value;
    ...
    $scope.DisplayUserMenu = function () {
        $scope.IsUserMenuVisible = !$scope.IsUserMenuVisible;
        if (loggedInUserDetailsCookie && loggedInUserDetailsCookie.RoleType === 'POD')
            ShoWUserInfo(loggedInUserDetailsCookie.UserId);
    };

    //$scope.DisplayUserMenuOutPatient = function () {
    //    $scope.IsUserMenuVisible = true;
    //};
    ...
    //    $http.post('PracticeManagement.Services/api/PodUser/UserInfo', data)
    //        .then(function successCallback(response) {
    //            if (response.data != undefined) {
    //                $scope.UserName = response.data;
    //            }
    //        }, function errorCallback(response) {
    //            exDialog.openMessage($scope, "Error occured while fetching records.", "Error", "error");
    //        });

    //}

    //$scope.AdminMenuVisible = true;
    //$scope.menuChanged = function (menu, startpage) {
    ...
    //    } else {
    //        $scope.states.activeItem = menu.Id;
    ...
    //            $rootScope.displayTitle = false;
    //        }
    //        if (menu.Name == 'ADMINISTRATION' && menu.Id == 1) {
    //            if ($scope.AdminMenuVisible == true) {
    //                $scope.Menus = $scope.AdminSubMenus;
    //                $scope.AdminMenuVisible = false;
    //            }
    //            else {
    //                $scope.Menus = $scope.AdminMenus;
    //                $scope.AdminMenuVisible = true;
    //            }
    //        }
    //    }
    ...
    //};
    //$scope.AdminMenus = [
    //         { Id: 1, Name: 'ADMINISTRATION', Class: 'administrationIcon', DeClass: 'deAdministrationIcon', Path: '/dashboard/administration', ImageArrow: 'adminDownArrowIcon' }
    //];

    //$scope.AdminSubMenus = [
    //    { Id: 1, Name: 'ADMINISTRATION', Class: 'administrationIcon', DeClass: 'deAdministrationIcon', Path: '/dashboard/administration', ImageArrow: 'adminUpArrowIcon' },
    //         { Id: 2, Name: 'USER ACCESS CONTROL', Class: 'SubmenuFontSize11px', DeClass: 'SubmenuFontSize11px', Path: '/dashboard/userAccessControl' },
    //         { Id: 3, Name: 'MISCELLANEOUS', Class: 'SubmenuFontSize11px', DeClass: 'SubmenuFontSize11px', Path: '/dashboard/miscellaneous' },
    //         { Id: 4, Name: 'USER MAPPING', Class: 'SubmenuFontSize11px', DeClass: 'SubmenuFontSize11px', Path: '/dashboard/userMapping' },
    //         { Id: 5, Name: "DOCTOR'S PROFILE", Class: 'SubmenuFontSize11px', DeClass: 'SubmenuFontSize11px', Path: '/dashboard/doctorsProfile' },
    //         { Id: 6, Name: 'PRINT LAYOUT', Class: 'SubmenuFontSize11px', DeClass: 'SubmenuFontSize11px', Path: '/dashboard/printLayout' },
    //         { Id: 7, Name: 'LOCATION MAPPING', Class: 'SubmenuFontSize11px', DeClass: 'SubmenuFontSize11px', Path: '/dashboard/locationMapping' }
    //];

    //$scope.SetVisibilityVariables = function () {
    //    for (var i = 0; i < $scope.Menus.length; i++) {
    //        $scope.SetValues($scope.Menus[i]);
    //    }
    //}

    //$scope.SetValues = function (menuItem) {
    //    switch (menuItem.Name) {
    //        case "OP SCHEDULE":
    //            $scope.CanViewOpSchedule = true;
    //            $scope.IsReadonlyOpSchedule = menuItem.AccessType == "View only";
    //            break;

    //        case "PATIENT SEARCH":
    //            $scope.CanViewPatientSearch = true;
    //            $scope.IsReadonlyPatientSearch = menuItem.AccessType == "View only";
    //            break;

    //        case "NOTIFICATIONS":
    //            $scope.CanViewNotifications = true;
    //            $scope.IsReadonlyNotifications = menuItem.AccessType == "View only";
    //            break;
    //    }
    //}

    
    //document.getElementById("pmapp").style.backgroundColor = "white";
