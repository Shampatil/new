'use strict';
gymManagementApp.controller('newAdmissionController', function ($scope,$uibModal, $log, $state, $http, $rootScope, $location, Idle, $route, exDialog, commonService, $localStorage, userSessionService) {
    ...
    $scope.init = function () {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            $scope.getpackagleveltaxamount = function()
            {
                ...
                for (var i = 0; i < $scope.fianlPackagesArray.length; i++)
                {
                    for (var j = 0; j < $scope.packagewithservice.length; j++)
                    {
                        if ($scope.fianlPackagesArray[i]["Packagename"] == $scope.packagewithservice[j]["PackageName"])
                        {
                            ...
                            if ($scope.packagewithservice[j]["ServicePrice"] !=null)
                            {
                            ...
                            if ($scope.packagewithservice[j]["TotalTax"] != null)
                            {
                                $scope.totaltaxapplied += discountamount * $scope.packagewithservice[j]["TotalTax"] / 100;
                            }
                            else
                            {
                                $scope.totaltaxapplied += discountamount * 1 / 100;
                            }
                    ...
                    for (var k = 0; k < $scope.taxes.length; k++)
                    {
                        ...
                        {
                            if ($scope.taxes[k]["Percentage"] != null)
                            {
                              //  console.log($scope.taxes[k]["Percentage"]);
               ...
               //     console.log(parseInt($scope.totalpackageprice) + "===" + parseInt($scope.totalpackagediscount) + "===" + $scope.packageleveltaxtotal)
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            $scope.submitinvoiceForm = function () {
                        ...
                        if ($scope.taxes[tx]["Product_Name"] == $scope.fianlPackagesArray[i]["Packagename"] && $scope.taxes[tx]["Product_Type"] == "Package Level Tax" && $scope.fianlPackagesArray[i]["Packagename"] != null) {
                            {
                                $scope.packagetaxes.push({
                                    ...
                                    packageName: $scope.taxes[tx]["Product_Name"],
                                })

                                       insert in Invoice Tax     
                                $.ajax({
                                    async: true,
                                    crossDomain: true,
                 ...
                 //   $scope.loop = 0
                    ...
                    for (var j = 0; j < $scope.packagewithservice.length; j++)
                    {
                        if ($scope.fianlPackagesArray[i]["Packagename"] == $scope.packagewithservice[j]["PackageName"])
                        {
                         ...
                         //   console.log(JSON.stringify($scope.myservices1))
                            //  insert in Service

                                   insert in invoice Service     
                            $.ajax({
                                async: true,
                                crossDomain: true,
                                    ...
                                    success: function () {
                                        ...
                                        if (!alert('Transaction Generated Sucessufully..!')) {
                                         ...
                                         //   setInterval('window.location.reload()', 5000);
                                          //  window.location = "index.html#/dashboard/newAdmission";
                                        }
                ...
                $.ajax({
                    async: true,
                    crossDomain: true,
                    url: "http://gym.excellencea.com/api/member",
                    method: "POST",
                    data:
                    {
                        "GYMID":$scope.SubmitGymID,
                    ...
                    error: function (req, status, errorObj) {
                        alert("Member Not Added : " + errorObj.toString());
                    }
                });
                ...
                $http({
                    url: "http://gym.excellencea.com/api/Enquiry/Update",
                    method: "POST",
                    params: {
                        "ID": $scope.id,
                        "Status": "Admitted"
                ...
                else
                {
                    ...
                    if (!alert('This Invoice Is Already Submitted Please Wail..!')) {
                       // window.location.reload();
                    }
                }
            }
