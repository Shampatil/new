...
gymManagementApp.controller('addWorkoutComponentsController', function ($scope, $state, $http, $rootScope, $location, Idle, $route, exDialog, commonService, $localStorage, userSessionService) {
    $scope.init();
    
    $scope.init = function () {
        Idle.watch();
        $location.path('/dashboard/addWorkoutComponents');
